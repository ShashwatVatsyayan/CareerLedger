...
struct SettingsView: View {
        ...
        GlassCard {
            VStack(alignment: .leading, spacing: 14) {
                ...
                HStack {
                    ...
                    Text(selectedTheme == "dark" ? "Dark Mode Active: Applied deeply across all pages and modals" : (selectedTheme == "light" ? "Light Mode Active" : "Following System Appearance"))
                        .font(.caption)
                        .foregroundStyle(.secondary)
                }
            }
    ...
    // MARK: - Privacy Policy Section (Separate Section)
    private var privacyPolicySection: some View {
        GlassCard {
            VStack(alignment: .leading, spacing: 12) {
                SectionHeader(title: "Privacy Policy", subtitle: "On-Device Storage & Zero Tracking")

                Text("Your data is encrypted locally with Apple SwiftData. We collect no analytics, behavioral data, or external telemetry.")
                    .font(.subheadline)
                    .foregroundStyle(.secondary)
                ...
                NavigationLink {
                    ...
                    HStack {
                        Label("Read Full Privacy Policy", systemImage: "hand.raised.fill")
                            .font(.subheadline)
                            .fontWeight(.semibold)
                            .foregroundStyle(.blue)
                        Spacer()
    ...
    // MARK: - Terms & Conditions Section (Separate Section)
    private var termsAndConditionsSection: some View {
        GlassCard {
            VStack(alignment: .leading, spacing: 12) {
                SectionHeader(title: "Terms & Conditions", subtitle: "Verifiable Credential & Academic Terms")

                Text("Review student data ownership, academic integrity guidelines, and credential verification terms.")
                    .font(.subheadline)
                    .foregroundStyle(.secondary)
                ...
                NavigationLink {
                    ...
                    HStack {
                        Label("Read Terms & Conditions", systemImage: "doc.plaintext.fill")
                            .font(.subheadline)
                            .fontWeight(.semibold)
